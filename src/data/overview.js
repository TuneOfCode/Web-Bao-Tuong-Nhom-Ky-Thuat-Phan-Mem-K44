...
import logobc from "../img/logobc.jpg";
import logocntt from "../img/logocntt.jpg";
import logodc from "../img/logodc.jpg";
import logohh from "../img/logohh.png";
import logokt from "../img/logokt.jpg";
import logollct from "../img/logollct.jpg";
import logomt from "../img/logomt.jpg";
import logosh from "../img/logosh.png";
import logodt from "../img/logodt.png";
...
const histories = [
  {
    ...
    img: logo,
    content:
      "Trường Đại học Khoa học, Đại học Huế (gọi tắt là trường\n" +
      "ĐHKH), tiền thân là trường Đại học Tổng hợp Huế, được thành\n" +
      "lập theo Quyết định số 426/TTg ngày 27-10-1976 của\n" +
      "Thủ tướng chính phủ trên cơ sở sát nhập Đại học Khoa học và\n" +
      "Đại học Văn khoa của Viện Đại học Huế trước đây (Viện ĐH Huế\n" +
      "thành lập năm 1957).",
  },
  {
    id: "2",
  ...
  {
    id: "6",
    title: "Khoa Điện, Điện tử và Công nghệ",
    img: logodt,
    content:
  ...
  },
  {
    ...
    img: logohh,
    content:
      "Từ những ngày đầu thành lập đến nay, Khoa Hóa trường Đại học Khoa học Huế đã tròn 60 tuổi, một chặng đường dài đã ghi dấu ấn của biết bao thế hệ thầy cô và sinh viên làm nên một Khoa Hóa ngày nay với bề dày truyền thống tốt đẹp.\n" +
      "Bên cạnh đào tạo và nghiên cứu Khoa học, hợp tác quốc tế cũng là một trong những nhiệm vụ ưu tiên hàng đầu của khoa nhằm mục đích đào tạo, nâng cao chất lượng cán bộ và hợp tác nghiên cứu. Khoa đã và đang thực hiện có hiệu quả nhiều dự án hợp tác quốc tế.",
  },
  {
    id: "8",
    title: "Khoa Sinh học",
    img: logosh,
    content:
      "Đào tạo nguồn nhân chất lượng cao ngành Kỹ thuật Sinh học, Công nghệ Sinh học, Sinh học thực nghiệm đáp ứng nhu cầu xã hội.\n" +
      "Đội ngũ giảng viên có kinh nghiệm và bề dày thành tích về giảng dạy và nghiên cứu khoa học, bao gồm: 01 GS, 10 PGS, 10 TS và 6 Ths.\n" +
      "02 phòng thực hành thí nghiệm cơ bản và 07 phòng thí nghiệm chuyên ngành được trang bị đầy đủ các thiết bị phục vụ nghiên cứu.",
  },
  {
    id: "9",
    title: "Khoa Địa lý - Địa chất",
    img: logodc,
    content:
      "Khoa Địa lý - Địa chất, trường Đại học Khoa học, Đại học Huế có sứ mạng đào tạo nguồn nhân lực chất lượng cao (Cử nhân, Kỹ sư, Thạc sĩ, Tiến sĩ), đảm nhận tốt các nhiệm vụ nghiên cứu cơ bản và ứng dụng kỹ thuật công nghệ cao trong lĩnh vực Khoa học Trái đất phục vụ phát triển kinh tế - xã hội cho đất nước trong thời đại cách mạng 4.0",
  },
  {
    id: "10",
  ...
  },
  {
    ...
    img: logokt,
    content:
      "Khoa Kiến trúc có sứ mạng đào tạo nguồn nhân lực chất lượng cao; nghiên cứu cơ bản và ứng dụng về khoa học tự nhiên, khoa học xã hội - nhân văn và kỹ thuật - công nghệ đáp ứng yêu cầu phát triển đất nước.\n" +
      "Với lịch sử trên 20 năm đào tạo ngành Kiến trúc và đội ngũ giảng viên có trình độ chuẩn quốc tế, nhiệt huyết, giàu kinh nghiệm khoa kiến trúc luôn sẵn sàng chào đón các bạn học viên từ khắp mọi miền đất nước đến học tập và nghiên cứu.",
  },
  {
    id: "12",
    title: "Khoa Ngữ văn",
    ...
    content:
      ...
      "Từ năm 1976-1985: Theo các tài liệu đã công bố, tiền thân của Trường Đại học Văn khoa là Ban Văn chương – một trong năm ban của Phân khoa Văn khoa, được thành lập ngày 01 tháng 03 năm 1957. Đến ngày 01 tháng 02 năm 1959, Viện Đại học Huế  chính thức ký quyết định thành lập Trường Đại học Văn khoa.\n" +
